...
class WebglTestTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(WebglTest)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(WebglTest)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/webgl-test/')  # The final '/' is essential for all pages/controllers
